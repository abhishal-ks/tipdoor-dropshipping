...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--primary)] via-[#7b3cf5] to-[#9d5ff5] py-12 md:py-16">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center animate-fade-in">
          ...
          <button
            ...
            className="inline-block bg-white text-[var(--primary)] font-bold px-8 py-3 rounded-xl hover:bg-gray-50 transition-all duration-300 shadow-2xl hover:shadow-white/20 hover:scale-105 transform"
          >
            Shop Now →
          </button>
        </div>
      ...
      <section id="products" className="max-w-6xl mx-auto px-6 -mt-8 md:-mt-12 py-16 md:py-20 relative z-10">
        <div className="mb-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 flex items-center justify-center gap-3">
            ...
            <span className="w-2 h-10 bg-gradient-to-b from-[var(--primary-light)] to-[var(--primary)] rounded-full" />
          </h2>
